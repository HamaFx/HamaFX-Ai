...
- [ ] Task 1.1 — Auth bypass fixed
- [ ] Task 1.2 — Onboarding redirect uses `/login`
- [ ] Task 1.3 — CSRF first-request no longer fails
- [ ] Task 1.4 — Email normalized
- [ ] Task 1.5 — `JSON.parse` wrapped in try-catch
- [ ] Task 1.6 — Journal delete returns proper errors
- [ ] Task 1.7 — No PII in logs
- [ ] Task 1.8 — All server actions return `{ ok, error }`
- [ ] Task 1.9 — `clearChatHistoryAction` has auth check
- [ ] Task 1.10 — Onboarding `displayName` saved
- [ ] Task 1.11 — Logout checks fetch result
- [ ] Task 1.12 — Password complexity enforced
- [ ] Task 1.13 — All `window.confirm` replaced
- [ ] Task 1.14 — No duplicate `id="main-content"`
- [ ] Task 1.15 — All API routes audited
