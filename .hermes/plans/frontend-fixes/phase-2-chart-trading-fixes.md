...
- [ ] Task 2.1 — Time-sync subscription leak fixed
- [ ] Task 2.2 — Chart no longer recreated on candle update
- [ ] Task 2.3 — `applyDecimals` called with correct precision
- [ ] Task 2.4 — `useChartTheme` uses state not ref
- [ ] Task 2.5 — Live candle stitching validates symbol/timestamps
- [ ] Task 2.6 — Empty candles clears chart
- [ ] Task 2.7 — Performance chart uses `applyOptions` for color
- [ ] Task 2.8 — Redundant ResizeObserver removed
- [ ] Task 2.9 — Theme effect no longer depends on `candles`
- [ ] Task 2.10 — `setMarkers` uses v5 API with v4 fallback
- [ ] Task 2.11 — localStorage writes consolidated
- [ ] Task 2.12 — `overlaySet` uses raw `candles`
- [ ] Task 2.13 — Settings drawer renders immediately
- [ ] Task 2.14 — `useSubPaneChart` hook extracted
- [ ] Task 2.15 — Theme presets consolidated
- [ ] Task 2.16 — "Volatity" typo fixed
- [ ] Task 2.17 — Overlay constants shared
- [ ] Task 2.18 — Dead code removed
- [ ] Task 2.19 — Error boundary added
- [ ] Task 2.20 — Crosshair sync implemented
- [ ] Task 2.21 — `useLightweightCharts` hook created
- [ ] Task 2.22 — `timeframeToMs` imported from shared
- [ ] Task 2.23 — TradingView widget uses `onLoad`
