...
| 08  | [backend-and-api](./08-backend-and-api.md)                 | Route map, edge vs node, worker service                  |
| 09  | [deployment](./09-deployment.md)                           | Vercel + Fly.io/Railway + envs + CI/CD                   |
| 10  | [roadmap](./10-roadmap.md)                                 | Milestones (Phase 0 → Phase 4)                           |
