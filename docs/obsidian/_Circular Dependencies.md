...
- 🔄 2 nodes: [[api-RequestUser]] → [[logger-createRequestLogger]]
- 🔄 2 nodes: [[rule-registry-SpecFactory]] → [[spec-RuleReading]]
- 🔄 2 nodes: [[evaluator-parseIndicatorSpec]] → [[delivery-DeliveryResult]]
- 🔄 2 nodes: [[dispatcher-BotDispatcher]] → [[help-helpCommand]]
