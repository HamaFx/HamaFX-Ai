...
type: table
package: "@kestrel/db"
path: "packages/db/src/schema/admin-audit.ts"
incoming: 0
outgoing: 1
connections: 1
risk: low
...
aliases: [admin_audit_log]
---

# 🗄️ admin_audit_log

> **DB Table** · `@kestrel/db` · `packages/db/src/schema/admin-audit.ts`


Database table: admin_audit_log (7 columns)
