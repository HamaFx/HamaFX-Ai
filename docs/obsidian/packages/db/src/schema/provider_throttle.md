...
type: table
package: "@hamafx/db"
path: "packages/db/src/schema/throttle.ts"
incoming: 0
outgoing: 1
connections: 1
risk: low
...
aliases: [provider_throttle]
---

# 🗄️ provider_throttle

> **DB Table** · `@hamafx/db` · `packages/db/src/schema/throttle.ts`


Database table: provider_throttle (4 columns)
