...
> **Module** · `@kestrel/shared` · `packages/shared/src/logger.ts`


Module: packages/shared/src/logger.ts
...
### 📤 Depends On (4)
[[error-patterns-ErrorPattern]] · [[log-stream-LogStreamClient]] · [[bug-report-DiagnosticStep]] · [[@kestrel-shared]]
