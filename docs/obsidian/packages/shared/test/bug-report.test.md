...
path: "packages/shared/test/bug-report.test.ts"
incoming: 0
outgoing: 4
connections: 4
risk: low
...
aliases: [bug-report.test]
---

# 📁 bug-report.test

> **Module** · `@kestrel/shared` · `packages/shared/test/bug-report.test.ts`


Module: packages/shared/test/bug-report.test.ts
