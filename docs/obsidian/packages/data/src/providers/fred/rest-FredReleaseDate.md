...
# 📁 rest/FredReleaseDate

> **Module** · `@kestrel/data` · `packages/data/src/providers/fred/rest.ts`


Module: packages/data/src/providers/fred/rest.ts
...
### 📤 Depends On (3)
[[throttle-ThrottleConfig]] · [[errors-DataErrorCode]] · [[@kestrel-data]]
