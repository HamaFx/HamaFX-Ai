...
path: "packages/data/src/providers/fred/map.ts"
incoming: 0
outgoing: 3
connections: 3
risk: low
...
aliases: [map/FredReleaseMeta]
---

# 📁 map/FredReleaseMeta

> **Module** · `@kestrel/data` · `packages/data/src/providers/fred/map.ts`


Module: packages/data/src/providers/fred/map.ts
