...
aliases: [finnhub-candles-map.test]
---

# 📁 finnhub-candles-map.test

> **Module** · `@kestrel/data` · `packages/data/test/finnhub-candles-map.test.ts`


Module: packages/data/test/finnhub-candles-map.test.ts
...
### 📤 Depends On (4)
[[vitest-installServerOnlyStub]] · [[rest-fetchPrice]] · [[map-toFinnhubSymbol]] · [[@kestrel-data]]
