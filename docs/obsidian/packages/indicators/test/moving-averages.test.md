...
> **Module** · `@kestrel/indicators` · `packages/indicators/test/moving-averages.test.ts`


Module: packages/indicators/test/moving-averages.test.ts
...
### 📤 Depends On (4)
[[vitest-installServerOnlyStub]] · [[moving-averages-sma]] · [[fixtures-makeCandles]] · [[@kestrel-indicators]]
