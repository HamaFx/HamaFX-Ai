...
# 📁 rule-registry/SpecFactory

> **Module** · `@kestrel/ai` · `packages/ai/src/alerts/rule-registry.ts`


Module: packages/ai/src/alerts/rule-registry.ts
...
### 📤 Depends On (3)
[[@kestrel-shared]] · [[spec-RuleReading]] · [[@kestrel-ai]]
