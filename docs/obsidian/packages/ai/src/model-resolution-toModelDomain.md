...
aliases: [model-resolution/toModelDomain]
---

# 📁 model-resolution/toModelDomain

> **Module** · `@hamafx/ai` · `packages/ai/src/model-resolution.ts`


Module: packages/ai/src/model-resolution.ts
