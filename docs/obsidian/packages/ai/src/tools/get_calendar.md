...
type: tool
package: "@hamafx/ai"
path: "packages/ai/src/tools/get-calendar.ts"
incoming: 2
outgoing: 7
connections: 9
risk: low
...
aliases: [get_calendar]
---

# 🔧 get_calendar

> **AI Tool** · `@hamafx/ai` · `packages/ai/src/tools/get-calendar.ts`
...
### 📥 Depended On By (2)
[[journal-toolRegistry]] · [[get-calendar.test]]
