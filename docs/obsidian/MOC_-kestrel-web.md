...
totalIncoming: 1006
totalOutgoing: 1390
tags: [moc, kestrel-web]
---

# 📦 @kestrel/web

> **Map of Content** · 684 files · 1006 incoming + 1390 outgoing = 2396 connections

## DataviewJS — All Files in This Package
```dataviewjs
const pages = dv.pages().where(p => p.package === "@kestrel/web" && p.type);
dv.table(
...
- [[auth.config-assertProductionSecurity]] *(2↖ 1↗)*
- [[chart-colors-SERIES_BULL_HEX]] *(0↖ 1↗)*
...
- [[performance-chart-PerformanceChart]] *(0↖ 4↗)*
