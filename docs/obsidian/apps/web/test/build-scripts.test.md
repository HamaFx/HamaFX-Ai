...
type: module
package: "@kestrel/web"
path: "apps/web/test/build-scripts.test.ts"
incoming: 0
outgoing: 2
connections: 2
risk: low
...
aliases: [build-scripts.test]
---

# 📁 build-scripts.test

> **Module** · `@kestrel/web` · `apps/web/test/build-scripts.test.ts`


Module: apps/web/test/build-scripts.test.ts
