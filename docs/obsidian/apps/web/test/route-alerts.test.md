...
type: module
package: "@kestrel/web"
path: "apps/web/test/route-alerts.test.ts"
incoming: 0
outgoing: 2
connections: 2
risk: low
...
aliases: [route-alerts.test]
---

# 📁 route-alerts.test

> **Module** · `@kestrel/web` · `apps/web/test/route-alerts.test.ts`


Module: apps/web/test/route-alerts.test.ts
