...
type: module
package: "@kestrel/web"
path: "apps/web/test/service-worker.test.ts"
incoming: 0
outgoing: 2
connections: 2
risk: low
...
aliases: [service-worker.test]
---

# 📁 service-worker.test

> **Module** · `@kestrel/web` · `apps/web/test/service-worker.test.ts`


Module: apps/web/test/service-worker.test.ts
