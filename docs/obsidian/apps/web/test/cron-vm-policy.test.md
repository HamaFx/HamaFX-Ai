...
type: module
package: "@kestrel/web"
path: "apps/web/test/cron-vm-policy.test.ts"
incoming: 0
outgoing: 2
connections: 2
risk: low
...
aliases: [cron-vm-policy.test]
---

# 📁 cron-vm-policy.test

> **Module** · `@kestrel/web` · `apps/web/test/cron-vm-policy.test.ts`


Module: apps/web/test/cron-vm-policy.test.ts
