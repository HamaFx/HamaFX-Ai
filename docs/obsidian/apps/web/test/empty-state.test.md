...
type: module
package: "@kestrel/web"
path: "apps/web/test/empty-state.test.tsx"
incoming: 0
outgoing: 2
connections: 2
risk: low
...
aliases: [empty-state.test]
---

# 📁 empty-state.test

> **Module** · `@kestrel/web` · `apps/web/test/empty-state.test.tsx`


Module: apps/web/test/empty-state.test.tsx
