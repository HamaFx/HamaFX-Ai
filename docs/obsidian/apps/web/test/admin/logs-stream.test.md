...
type: module
package: "@kestrel/web"
path: "apps/web/test/admin/logs-stream.test.ts"
incoming: 0
outgoing: 2
connections: 2
risk: low
...
aliases: [logs-stream.test]
---

# 📁 logs-stream.test

> **Module** · `@kestrel/web` · `apps/web/test/admin/logs-stream.test.ts`


Module: apps/web/test/admin/logs-stream.test.ts
