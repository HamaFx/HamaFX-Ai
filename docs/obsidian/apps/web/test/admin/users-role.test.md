...
type: module
package: "@kestrel/web"
path: "apps/web/test/admin/users-role.test.ts"
incoming: 0
outgoing: 2
connections: 2
risk: low
...
aliases: [users-role.test]
---

# 📁 users-role.test

> **Module** · `@kestrel/web` · `apps/web/test/admin/users-role.test.ts`


Module: apps/web/test/admin/users-role.test.ts
