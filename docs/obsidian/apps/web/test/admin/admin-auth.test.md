...
type: module
package: "@kestrel/web"
path: "apps/web/test/admin/admin-auth.test.ts"
incoming: 0
outgoing: 2
connections: 2
risk: low
...
aliases: [admin-auth.test]
---

# 📁 admin-auth.test

> **Module** · `@kestrel/web` · `apps/web/test/admin/admin-auth.test.ts`


Module: apps/web/test/admin/admin-auth.test.ts
