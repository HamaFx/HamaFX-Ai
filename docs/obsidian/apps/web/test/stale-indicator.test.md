...
type: module
package: "@kestrel/web"
path: "apps/web/test/stale-indicator.test.tsx"
incoming: 0
outgoing: 2
connections: 2
risk: low
...
aliases: [stale-indicator.test]
---

# 📁 stale-indicator.test

> **Module** · `@kestrel/web` · `apps/web/test/stale-indicator.test.tsx`


Module: apps/web/test/stale-indicator.test.tsx
