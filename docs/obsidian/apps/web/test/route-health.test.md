...
type: module
package: "@kestrel/web"
path: "apps/web/test/route-health.test.ts"
incoming: 0
outgoing: 2
connections: 2
risk: low
...
aliases: [route-health.test]
---

# 📁 route-health.test

> **Module** · `@kestrel/web` · `apps/web/test/route-health.test.ts`


Module: apps/web/test/route-health.test.ts
