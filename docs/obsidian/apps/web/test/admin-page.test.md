...
type: module
package: "@kestrel/web"
path: "apps/web/test/admin-page.test.tsx"
incoming: 0
outgoing: 2
connections: 2
risk: low
...
aliases: [admin-page.test]
---

# 📁 admin-page.test

> **Module** · `@kestrel/web` · `apps/web/test/admin-page.test.tsx`


Module: apps/web/test/admin-page.test.tsx
