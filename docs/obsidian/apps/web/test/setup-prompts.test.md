...
type: module
package: "@kestrel/web"
path: "apps/web/test/setup-prompts.test.ts"
incoming: 0
outgoing: 2
connections: 2
risk: low
...
aliases: [setup-prompts.test]
---

# 📁 setup-prompts.test

> **Module** · `@kestrel/web` · `apps/web/test/setup-prompts.test.ts`


Module: apps/web/test/setup-prompts.test.ts
