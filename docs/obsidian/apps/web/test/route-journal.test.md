...
type: module
package: "@kestrel/web"
path: "apps/web/test/route-journal.test.ts"
incoming: 0
outgoing: 2
connections: 2
risk: low
...
aliases: [route-journal.test]
---

# 📁 route-journal.test

> **Module** · `@kestrel/web` · `apps/web/test/route-journal.test.ts`


Module: apps/web/test/route-journal.test.ts
