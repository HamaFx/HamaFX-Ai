...
type: module
package: "@kestrel/web"
path: "apps/web/test/setup-pages.test.ts"
incoming: 0
outgoing: 2
connections: 2
risk: low
...
aliases: [setup-pages.test]
---

# 📁 setup-pages.test

> **Module** · `@kestrel/web` · `apps/web/test/setup-pages.test.ts`


Module: apps/web/test/setup-pages.test.ts
