...
type: module
package: "@kestrel/web"
path: "apps/web/test/format-number.test.ts"
incoming: 0
outgoing: 2
connections: 2
risk: low
...
aliases: [format-number.test]
---

# 📁 format-number.test

> **Module** · `@kestrel/web` · `apps/web/test/format-number.test.ts`


Module: apps/web/test/format-number.test.ts
