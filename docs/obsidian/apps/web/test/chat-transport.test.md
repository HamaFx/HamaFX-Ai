...
type: module
package: "@kestrel/web"
path: "apps/web/test/chat-transport.test.ts"
incoming: 0
outgoing: 2
connections: 2
risk: low
...
aliases: [chat-transport.test]
---

# 📁 chat-transport.test

> **Module** · `@kestrel/web` · `apps/web/test/chat-transport.test.ts`


Module: apps/web/test/chat-transport.test.ts
