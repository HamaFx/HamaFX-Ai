...
type: module
package: "@kestrel/web"
path: "apps/web/test/admin-system-health.test.tsx"
incoming: 0
outgoing: 2
connections: 2
risk: low
...
aliases: [admin-system-health.test]
---

# 📁 admin-system-health.test

> **Module** · `@kestrel/web` · `apps/web/test/admin-system-health.test.tsx`


Module: apps/web/test/admin-system-health.test.tsx
