...
type: module
package: "@kestrel/web"
path: "apps/web/test/dev-secrets.test.ts"
incoming: 0
outgoing: 2
connections: 2
risk: low
...
aliases: [dev-secrets.test]
---

# 📁 dev-secrets.test

> **Module** · `@kestrel/web` · `apps/web/test/dev-secrets.test.ts`


Module: apps/web/test/dev-secrets.test.ts
