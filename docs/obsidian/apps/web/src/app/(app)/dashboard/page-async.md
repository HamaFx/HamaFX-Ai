...
> **Module** · `@kestrel/web` · `apps/web/src/app/(app)/dashboard/page.tsx`


Module: apps/web/src/app/(app)/dashboard/page.tsx
...
### 📤 Depends On (3)
[[@kestrel-ai]] · [[dashboard-canvas-DashboardCanvas]] · [[@kestrel-web]]
