...
> **Module** · `@kestrel/web` · `apps/web/src/app/(app)/chart/[symbol]/page.tsx`


Module: apps/web/src/app/(app)/chart/[symbol]/page.tsx
...
### 📤 Depends On (3)
[[@kestrel-shared]] · [[pro-chart-view-ProChartView]] · [[@kestrel-web]]
