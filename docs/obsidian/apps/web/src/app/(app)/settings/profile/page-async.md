...
> **Module** · `@kestrel/web` · `apps/web/src/app/(app)/settings/profile/page.tsx`


Module: apps/web/src/app/(app)/settings/profile/page.tsx
...
### 📤 Depends On (2)
[[profile-form-ProfileForm]] · [[@kestrel-web]]
