...
> **Module** · `@kestrel/web` · `apps/web/src/app/(auth)/reset-password/page.tsx`


Module: apps/web/src/app/(auth)/reset-password/page.tsx
...
### 📤 Depends On (2)
[[reset-password-form-ResetPasswordForm]] · [[@kestrel-web]]
