...
type: component
package: "@kestrel/web"
path: "apps/web/src/components/chart/price-tag.tsx"
incoming: 0
outgoing: 2
connections: 2
risk: low
...
aliases: [price-tag/PriceTag]
---

# 🧩 price-tag/PriceTag

> **Component** · `@kestrel/web` · `apps/web/src/components/chart/price-tag.tsx`


React component: price-tag
