...
type: component
package: "@kestrel/web"
path: "apps/web/src/components/chart/chart-macd.tsx"
incoming: 1
outgoing: 8
connections: 9
risk: low
...
aliases: [chart-macd/ChartMACDProps]
---

# 🧩 chart-macd/ChartMACDProps

> **Component** · `@kestrel/web` · `apps/web/src/components/chart/chart-macd.tsx`


React component: chart-macd
