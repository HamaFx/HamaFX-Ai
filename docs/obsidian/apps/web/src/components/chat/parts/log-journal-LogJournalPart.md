...
type: component
package: "@kestrel/web"
path: "apps/web/src/components/chat/parts/log-journal.tsx"
incoming: 1
outgoing: 3
connections: 4
risk: low
...
aliases: [log-journal/LogJournalPart]
---

# 🧩 log-journal/LogJournalPart

> **Component** · `@kestrel/web` · `apps/web/src/components/chat/parts/log-journal.tsx`


React component: log-journal
