...
# 🧩 thread-switcher/ThreadSwitcher

> **Component** · `@kestrel/web` · `apps/web/src/components/chat/_components/thread-switcher.tsx`


React component: thread-switcher
...
### 📤 Depends On (2)
[[chat-top-bar-AnalysisMode]] · [[@kestrel-web]]
