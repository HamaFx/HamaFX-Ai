...
type: module
package: "@kestrel/web"
path: "apps/web/tests/e2e/admin-dashboard.spec.ts"
incoming: 0
outgoing: 2
connections: 2
risk: low
...
aliases: [admin-dashboard.spec]
---

# 📁 admin-dashboard.spec

> **Module** · `@kestrel/web` · `apps/web/tests/e2e/admin-dashboard.spec.ts`


Module: apps/web/tests/e2e/admin-dashboard.spec.ts
