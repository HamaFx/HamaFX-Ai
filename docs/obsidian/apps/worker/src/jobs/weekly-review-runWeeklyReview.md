...
> **Module** · `@kestrel/worker` · `apps/worker/src/jobs/weekly-review.ts`


Module: apps/worker/src/jobs/weekly-review.ts
...
### 📤 Depends On (4)
[[@kestrel-ai]] · [[@kestrel-db]] · [[types-JobCoreContext]] · [[@kestrel-worker]]
