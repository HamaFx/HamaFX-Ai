...
# 📁 knowledge-generator/KnowledgeOutput

> **Module** · `tool:architecture-explorer` · `tools/architecture-explorer/src/knowledge-generator.ts`


Module: tools/architecture-explorer/src/knowledge-generator.ts
