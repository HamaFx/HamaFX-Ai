...
- [ ] 1. T1 — Fix cron scheduling (Requirement 1)
  - [ ] 1.1 Add `crons` array to `apps/web/vercel.json`
  ...
  - [ ] 1.2 Add admin-bypass to `withCronAuth`
...
- [ ] 2. T2 — Chart page loading/error/empty states (Requirement 2)
  ...
  - [ ] 2.4 Wire states into `ChartView`
...
- [ ] 3. T3 — News page improvements (Requirement 3)
  ...
  - [ ] 3.3 Improve `ArticleCard` sentiment display
...
- [ ] 4. T4 — Calendar page improvements (Requirement 4)
  ...
  - [ ] 4.4 Show actual vs forecast delta
    - When `actual` is filled, show a beat/miss indicator (green up arrow / red down arrow).
    - _Requirements: 4.4_
    - Files: `apps/web/src/components/calendar/event-card.tsx`
  - [ ] 4.5 Add `loading.tsx` for streaming SSR
    - _Requirements: 8.4_
    - Files: `apps/web/src/app/(app)/calendar/loading.tsx`

- [ ] 5. T5 — Indicator accuracy upgrades (Requirement 5)
  - [ ] 5.1 Adaptive swing lookback defaults
  ...
  - [ ] 5.2 Order block strength score
...
- [ ] 7. T7 — Error handling & resilience (Requirement 7)
  - [ ] 7.1 Exponential backoff in `useCandles` and `useStructure`
...
- [ ] 8. T8 — Performance & accessibility (Requirement 8)
  - [ ] 8.1 Lazy-load `lightweight-charts`
...
- [ ] 9. Checkpoint — all pages render data
