...
export function AmbientBackground() {
  return (
    ...
    >
      {/* Top-right amber orb (static) */}
      <div
        className="absolute -top-32 -right-32 h-[28rem] w-[28rem] rounded-full opacity-25 blur-[100px]"
        style={{ background: 'oklch(78% 0.16 78 / 1)' }}
      />
      {/* Bottom-left violet orb (static) */}
      <div
        className="absolute -bottom-32 -left-32 h-[32rem] w-[32rem] rounded-full opacity-20 blur-[120px]"
        style={{ background: 'oklch(72% 0.18 295 / 1)' }}
      />
      {/* Center cyan orb (subtle, static) */}
      <div
        className="absolute left-1/2 top-1/3 h-[24rem] w-[24rem] -translate-x-1/2 rounded-full opacity-10 blur-[110px]"
