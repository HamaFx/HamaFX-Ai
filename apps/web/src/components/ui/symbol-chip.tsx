...
export function SymbolChip({
  ...
  return (
    <span
      ...
      className={cn(
        'bg-zinc-800 text-fg ring-zinc-700 inline-flex items-center gap-1 rounded-sm px-2 py-0.5 text-caption font-bold uppercase tabular-nums ring-1',
        className,
      )}
    >
      <span>{symbol}</span>
      {removable ? (
        <button
          ...
          className={cn(
            ...
            'hover:bg-zinc-800 focus-visible:bg-brand/25 focus-visible:ring-2 focus-visible:ring-zinc-700 focus:outline-none',
