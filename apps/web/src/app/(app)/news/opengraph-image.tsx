      ...
      >
        ...
        <div
          style={{
            ...
            height: 400,
            borderRadius: '50%',
            background: 'radial-gradient(circle, rgba(245, 110, 15, 0.15) 0%, rgba(245, 110, 15, 0) 70%)',
          }}
        />
        ...
        >
          AI-filtered global macroeconomic headlines, central bank sentiment, and real-time trade catalysts
        </div>
