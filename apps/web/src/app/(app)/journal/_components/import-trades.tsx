    ...
    <>
      ...
      {open && (
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/60">
          <div className="w-full sm:max-w-lg rounded-t-2xl sm:rounded-2xl bg-bg-elev-1 border border-divider p-6 flex flex-col gap-4 max-h-[80vh] overflow-y-auto">
            ...
            {!parsed ? (
              <div className="flex flex-col gap-3">
                ...
                <label className="flex items-center justify-center gap-2 rounded-lg border border-dashed border-divider p-6 text-sm text-fg-subtle hover:border-brand hover:text-fg transition-colors cursor-pointer">
