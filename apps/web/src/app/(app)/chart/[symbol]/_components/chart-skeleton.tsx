...
export function ChartSkeleton() {
  return (
    <div role="status" aria-label="Loading content" className="border border-zinc-800 bg-zinc-950 rounded-sm relative flex h-[60svh] w-full items-center justify-center overflow-hidden">
