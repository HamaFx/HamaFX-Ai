...
export default async function LoginPage({ searchParams }: PageProps) {
  ...
  return (
    ...
    >
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute left-1/2 top-1/3 h-[36rem] w-[36rem] -translate-x-1/2 -translate-y-1/2 rounded-full opacity-25 blur-[120px]"
        style={{ background: 'oklch(78% 0.16 78 / 1)' }}
      />
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -bottom-32 -right-32 h-[28rem] w-[28rem] rounded-full opacity-20 blur-[120px]"
        style={{ background: 'oklch(72% 0.18 295 / 1)' }}
      />
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -top-32 -left-32 h-[24rem] w-[24rem] rounded-full opacity-15 blur-[100px]"
