...
- [x] Task 4.1 — `color-scheme: dark` added
- [x] Task 4.2 — `startsWith('/chat')` uses segment matching
- [x] Task 4.3 — Segmented always has `aria-label`
- [x] Task 4.4 — Confirm drawer stabilized
- [x] Task 4.5 — Server actions return errors not throw
- [x] Task 4.6 — Division by zero handled
- [x] Task 4.7 — Logout checks fetch result
- [x] Task 4.8 — Segmented has roving tabindex
- [x] Task 4.9 — Symbol chip clear ≥44pt
- [x] Task 4.10 — Command palette has arrow keys
- [x] Task 4.11 — Settings nav has `aria-current`
- [x] Task 4.12 — Model picker has loading skeleton
- [x] Task 4.13 — Data card indentation fixed
- [x] Task 4.14 — All dead code removed
- [x] Task 4.15 — iPad iOS 13+ detection fixed
- [x] Task 4.16 — Offline banner has retry loading
- [x] Task 4.17 — Command palette children have keys
- [x] Task 4.18 — Manifest description generic
- [x] Task 4.19 — Symbols page uses design token
- [x] Task 4.20 — Settings page whitespace fixed
- [x] Task 4.21 — Multiple apple splash images
- [x] Task 4.22 — `useLocalStorage` hook created
- [x] Task 4.23 — `aria-live` for toasts
- [x] Task 4.24 — Server action error handling consistent
- [x] Task 4.25 — `clearChatHistoryAction` has auth
- [x] Task 4.26 — Ambient background respects reduced motion
- [x] Task 4.27 — Page header responsive
- [x] Task 4.28 — Empty state accessible
- [x] Task 4.29 — Stat card has `aria-label`
- [x] Task 4.30 — Sparkline SVG accessible
- [x] Task 4.31 — Animated number respects reduced motion
- [x] Task 4.32 — Provider info dot accessible
- [x] Task 4.33 — Stale indicator has `aria-live`
- [x] Task 4.34 — Switch has focus-visible ring
- [x] Task 4.35 — Input has `aria-invalid`
- [x] Task 4.36 — Drawer has focus trap
