...
- [x] Task 5.1 — Bookmarks lifted to context
- [x] Task 5.2 — ArticleCard memoized
- [x] Task 5.3 — Live timestamp interval cleaned up
- [x] Task 5.4 — News infinite scroll implemented
- [x] Task 5.5 — Journal entry list virtualized
- [x] Task 5.6 — Journal entry form validated
- [x] Task 5.7 — Journal stats handles empty state
- [x] Task 5.8 — Calendar event times in local timezone
- [x] Task 5.9 — Calendar view has loading/error states
- [x] Task 5.10 — Calendar toolbar filters persist in URL
- [x] Task 5.11 — Alert form validated
- [x] Task 5.12 — Alert list has empty state
- [x] Task 5.13 — Dashboard uses real data
- [x] Task 5.14 — `formatRelative` consolidated
- [x] Task 5.15 — Session DST handling implemented
- [x] Task 5.16 — Storage utilities have error handling
- [x] Task 5.17 — Fuzzy match handles edge cases
- [x] Task 5.18 — Commands typed and validated
- [x] Task 5.19 — Thread export handles large threads
- [x] Task 5.20 — Environment variables validated
- [x] Task 5.21 — Sentry configured with privacy scrubbing
- [x] Task 5.22 — Service worker shows update notification
- [x] Task 5.23 — React Query default options configured
- [x] Task 5.24 — Provider order correct
- [x] Task 5.25 — Share page works without auth
- [x] Task 5.26 — Offline page is static
- [x] Task 5.27 — Root page redirects correctly
- [x] Task 5.28 — 404 page styled
- [x] Task 5.29 — Error page has recovery options
- [x] Task 5.30 — Market client has error handling
- [x] Task 5.31 — Catalog server cached
- [x] Task 5.32 — Request ID propagated
- [x] Task 5.33 — Cron jobs have timeout and error handling
- [x] Task 5.34 — Sentiment summary handles empty data
- [x] Task 5.35 — Refresh button has loading state
- [x] Task 5.36 — News toolbar filters persist in URL
- [x] Task 5.37 — Calendar hero stats handle empty data
- [x] Task 5.38 — Usage page handles empty data
- [x] Task 5.39 — Bulk test button shows progress
- [x] Task 5.40 — Save bar warns about unsaved changes
- [x] Task 5.41 — Agent settings page fixed
- [x] Task 5.42 — Full verification: typecheck, lint, test, build, a11y, performance
